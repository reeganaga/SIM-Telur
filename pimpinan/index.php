...
<script src="../bootstrap/js/bootstrap.min.js"></script>
  ...
  <script type="text/javascript" src="tanggal.js">
  </script>
...
<?php
  session_start();
  if ( !isset($_SESSION['level']) || ( isset($_SESSION['level']) && $_SESSION['level'] != 'pimpinan' ) ) 
  {
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="index.php?menu=data_stok"><i class="fa fa-book"></i> <span>Data Persediaan</span></a></li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="index.php?menu=laporan-data-produksi"> Laporan Data Produksi</a></li>
            <li><a href="index.php?menu=laporan-data-penjualan"> Laporan Data Penjualan</a></li>
            <li><a href="index.php?menu=laporan-data-stok"> Laporan Data Persediaan</a></li>
          </ul>
        </li>
