...
<div class="box box-info">
  ...
  <?php if (isset($_GET['error'])) : ?>
    ...
    <?php endif;?>
    <a href="cetak-laporan-stok.php?tgl=<?php echo date('Y-m'); ?>" target="_blank"><span class="btn btn-sm btn-info"><i class="glyphicon glyphicon-print"> Cetak</i></span></a>
    <a href="arsip-laporan-stok.php?tgl=<?php echo date('Y-m'); ?>"><span class="btn btn-sm btn-info"><i class="glyphicon glyphicon-download"> Download</i></span></a>
